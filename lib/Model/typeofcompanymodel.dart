...
TypeofcompanyModel typeofcompanyModelFromJson(String? str) =>
    TypeofcompanyModel.fromJson(json.decode(str!));

String? typeofcompanyModelToJson(TypeofcompanyModel data) =>
...
class TypeofcompanyModel {
  ...
  factory TypeofcompanyModel.fromJson(Map<String?, dynamic> json) =>
      TypeofcompanyModel(
  ...
  factory Data.fromJson(Map<String?, dynamic> json) => Data(
        companyType: json["company_type"] == null
            ...
            : List<CompanyType>.from(
                json["company_type"].map((x) => CompanyType.fromJson(x))),
      );

  Map<String?, dynamic> toJson() => {
        "company_type": companyType == null
            ? null
            : List<dynamic>.from(companyType!.map((x) => x.toJson())),
      };
}
