                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    ...
                                    Expanded(
                                        child: Container(
                                      child: const Text(
                                          "Partner with one of the Top IT Company",
                                          style: TextStyle(
                                            fontSize: 20,
                                            letterSpacing: 1,
                                          )),
                                  ...
                                  Row(children: [
                                    ...
                                    Expanded(
                                        child: Container(
                                      child: const Text(
                                          "Easy Processing and Faster Payment.",
                                          style: TextStyle(
                                            fontSize: 20,
                                            letterSpacing: 1,
                                          )),
                                  ...
                                  Row(children: [
                                    ...
                                    Expanded(
                                        child: Container(
                                      child: const Text(
                                          "Work with High Tech Projects of PSU & Government Sectors.",
                                          style: TextStyle(
                                            fontSize: 20,
                                            letterSpacing: 1,
                                          )),
