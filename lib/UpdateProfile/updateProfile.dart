            ...
            children: [
              Container(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    'Personal Details',
                    style: SWANWidget.fieldLabelTextStyle,
                  ),
                  trailing: _isVisible
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SWANWidget.enabledTextFormField(
                                lastName, 'Last Name', TextInputType.text, [
                            ...
                            SWANWidget.enabledTextFormField(
                                work, 'Work Title', TextInputType.text, [
                              FilteringTextInputFormatter.deny(RegExp("[0-9]"))
                            ], (value) {
                              if (value.isEmpty) {
                                return 'The field is mandatory';
                            ...
                            SWANWidget.enabledTextFormField(pancard,
                                'PAN Card Number', TextInputType.text, [
                              FilteringTextInputFormatter.singleLineFormatter
                            ], (value) {
                              if (value.isEmpty) {
                                return 'The field is mandatory';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SWANWidget.enabledTextFormField(vendorid,
                                'Enter GST number', TextInputType.text, [
                              FilteringTextInputFormatter.singleLineFormatter
                            ], (value) {
                              if (value.isEmpty) {
                                return 'The field is mandatory';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SWANWidget.enabledTextFormField(
                                ifsc, 'IFSC Code', TextInputType.text, [
                              FilteringTextInputFormatter.singleLineFormatter
                            ], (value) {
                              if (value.isEmpty) {
                                return 'The field is mandatory';
                            ...
                            SWANWidget.enabledTextFormField(accHolderName,
                                'Account Holder Name', TextInputType.text, [
                              FilteringTextInputFormatter.deny(RegExp("[0-9]"))
                            ], (value) {
                              if (value.isEmpty) {
                                return 'The field is mandatory';
