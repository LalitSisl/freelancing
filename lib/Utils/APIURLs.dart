class APIUrls {
  ...
  static const String BASE_URL_IMAGE =
      "http://52.172.214.245/sisl-swan/"; //Testing
  ...
  static const String GET_EXPERIENCE =
      "/sisl-swan/index.php/api/work_experience_master";
  static const String GET_QUALIFICATION =
      "/sisl-swan/index.php/api/qualification_master";
  ...
  static const String GET_USER_COMPLETE_DETAILS =
      "/sisl-swan/index.php/api/user_complete_details";
  static const String GET_VENDOR_COMAPNY_TYPE =
      "/sisl-swan/index.php/api/company_types_master";
